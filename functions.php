...
// theme css
function theme_css() {
  wp_enqueue_style('theme-styles', get_theme_file_uri('/dist/css/styles.css'), [], null, 'screen');
}
add_action('wp_enqueue_scripts', 'theme_css');

// theme js
function theme_js() {
  wp_enqueue_script('theme-scripts', get_theme_file_uri('/dist/js/scripts.js'), [], null, true);
}
